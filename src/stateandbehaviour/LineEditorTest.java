...
public class LineEditorTest extends TestCase {
	...
	public void testInsertString() {
		...
		lineEditor.insertString(" er g퓓!");
		testLineEditor("Java er g퓓!",  12);

		setLineEditor("Javag퓓!", 4);
		lineEditor.insertString(" er ");
		testLineEditor("Java er g퓓!",  8);
		
		setLineEditor("er g퓓!", 0);
		lineEditor.insertString("Java ");
		testLineEditor("Java er g퓓!",  5);
	}
